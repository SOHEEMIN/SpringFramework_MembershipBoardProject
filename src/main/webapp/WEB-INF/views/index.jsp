...
<head>
    ...
    <style>
        /*body{width:100%; height:100%; background:url('/resources/img/sky.jpg') no-repeat center center / contain; margin:0;}*/
        .img_box{width:476px; height:540px; background:url('/resources/img/sky.jpg') no-repeat center center / contain; margin:0;}
    </style>
</head>
<body>
...
<header>
    ...
    Welcome to<br>Sohee's Retro Community!<br>
    <c:if test="${sessionScope.loginMemberId != null}">
        <br><h5>nice to meet you again ${sessionScope.loginMemberId}! </h5>
    </c:if>
</header>
<table>
