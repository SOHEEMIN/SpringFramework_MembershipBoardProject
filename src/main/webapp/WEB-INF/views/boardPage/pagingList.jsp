...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/pagingList.css">
    <meta charset="UTF-8">
    ...
    <div class="container1">
        <table class="table">
            ...
            <tr>
                ...
                <td id="title"><a href="/board/detail?page=${paging.page}&b_id=${board.b_id}">${board.boardTitle}</a></td>
                <td id="writer">${board.memberId}</td>
                <td id="hits">${board.boardHits}</td>
                <td id="date">${board.boardCreatedDate}</td>
                <td id="pic"><img src="${pageContext.request.contextPath}/upload/${board.boardFileName}" alt="" height="40"
                         width="40"></td>
        ...
        <ul class="pagination justify-content-center">
            <tr>
                <c:choose>
                    ...
                    <c:otherwise>
                        <td class="page-item">
                        <td><a class="page-link" href="/board/paging?page=${paging.page-1}">[이전]</a></td>
                        </td>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <td class="page-item">
                        <td><a class="page-link" href="/board/paging?page=${paging.page+1}">[다음]</a></td>
                        <td/>
                    </c:otherwise>
                </c:choose>
            </tr>
